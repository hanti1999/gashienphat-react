...
const ProductDetails = () => {
    ...
    const {imgUrl, productName, oldPrice, price, description, category} = product;
                        ...
                        <div className="col-span-6">
                            <div className="product__details mt-20">
                                ...
                                <div className='product__price flex items-center'>
                                    <span className={`${oldPrice === 0 ? 'hidden' : 'line-through text-14 mr-4'}`}>{oldPrice}</span>
                                    <span className='text-18 font-medium mr-4'>{price} vnđ</span>
