...
const BepDien = () => {
  return (
    <Helmet title='Bếp điện'>
      <CommonSection title='Bếp điện'/>
        ...
        <div className="shop__filter grid grid-cols-12 my-8 gap-3">
          <div className="col-span-3 max-lg:col-span-6 sm:max-lg:text-center">
            <div className="filter__widget">
              <select onChange={handleBrand} className="w-full cursor-pointer rounded-lg bg-primary text-white py-3 px-8 border border-solid border-primary">
          ...
          <div className="col-span-3 max-lg:col-span-6 sm:max-lg:text-end">
            <div className="filter__widget">
              <select onChange={handleSortPrice} className="w-full cursor-pointer rounded-lg bg-primary text-white py-3 px-8 border border-solid border-primary">
