...
const blogItems = [
    {
        id: 1,
        blogName: 'Giá gas tháng 07/2023 giảm 18.000đ/b',
        blogDate: '01/07/2023',
        blogCmt: '0',
        blogImg: blogImg1,
        blogDesc: 'Gía gas trong nước tiếng tục giảm. Công ty Cổ phần Kinh doanh Khí Miền Nam (Gas South) thông báo từ ngày 1-7, giá gas giảm 18.000/b so với tháng trước'
    },
    {
        id: 2,
