...
import productImg45 from '../img/product/rinnai2bg.png'
...
const products = [
    ...
    },
    {
        id: '45',
        imgUrl: productImg45,
        productName: 'Bếp gas âm Rinnai RVB-2BG', 
        category: 'bep-gas',
        displayHome: '',
        warranty: '2',
        apr: 'Trả góp 0%',
        ...
        description: [
            'Mặt kính cường lực, chịu nhiệt',
            'Kiềng thép tráng men chống dính',
            'Đánh lửa IC dùng pin, nhanh và nhẹ',
            'Cảm ứng ngắt gas tự động',
            'Đầu đốt hợp kim nhôm Rinnai, kèm đầu hâm',
            'Tích hợp chân đế, dùng được lắp âm và để bàn',
            'kích thước cắt đá: 675x365 mm',
            'Sản xuất tại Việt Nam'
        ],
        reviews: [
            {
